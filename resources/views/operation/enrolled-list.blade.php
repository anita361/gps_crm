...
<script>
    ...
    if (!id) {
        ...
        console.log('Notes: Student ID missing');

        return;
    }


    console.log('Loading notes for ID:', id);
    ...
    $.ajax({
        ...
        error: function(xhr) {
            ...
            let message = 'Unable to load Notes.';
