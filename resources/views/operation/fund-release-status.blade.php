                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button"
                                            class="btn btn-secondary btn-sm add-student-id-btn"
                                            data-sno="{{ $row->sno ?? '' }}"
                                            data-name="{{ $row->sname ?? '' }}"
                                            data-file-no="{{ $row->file_no ?? '' }}"
...
<div class="modal fade"
    id="studentIdModal"
    tabindex="-1"
    aria-labelledby="studentIdModalLabel"
    aria-hidden="true">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="studentIdModalLabel">
                    Add Student ID
                </h5>
...
$(document).on('click', '.add-student-id-btn', function() {
    ...
    $('#student_id_sno').val(sno);
    $('#student_id_student_name').val(name);
    $('#student_id_file_no').val(fileNo);
    $('#student_id_value').val(studentId || '');

    let modalElement = document.getElementById('studentIdModal');
...
$(document).on('submit', '#studentIdForm', function(e) {

    e.preventDefault();

    let form = $(this);
    let btn = $('#saveStudentIdBtn');

    $.ajax({

        url: "{{ route('operation.student-id.update') }}",
        ...
        success: function(response) {
            ...
            btn.html(
                '<i class="fa fa-save"></i> Save Student ID'
            );
            ...
            if (typeof Swal !== 'undefined') {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Success',
                    text: response.message || 'Student ID updated successfully'
                }).then(function() {
        ...
        error: function(xhr) {
            ...
            let message = 'Unable to update Student ID.';
