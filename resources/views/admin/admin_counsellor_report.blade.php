    ...
    <div class="counsellor-page">
        ...
        ====================================================== --}}
            ...
            <div class="crm-box">
                ...
                <form class="form_submit_change_status" method="POST"
                    action="{{ route('admin.counsellor.report.export') }}" autocomplete="off">

                    @csrf

                    <input type="hidden" name="branch" id="export_branch" value="all_branch">


                    <div class="export-wrapper">

                        <button type="submit" class="btn crm-export-btn">
                ...
                <div class="user-table-wrapper">
                    ...
                    <table id="appointment_data" class="table" width="100%">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="CalllogsLabel">
                        ...
                        <img src="{{ asset('images/call-log.png') }}" alt="Call Logs">
    ...
    @push('scripts')
     ...
     alt="Call Logs">
                    ...
                    `;
                                ...
                                let viewUrl =
                                    "{{ url('/walking-details') }}/" +
                                    encodeURIComponent(user.mobile || '');
