                ...
                <div class="row">
                    ...
                    @if ($alreadySigned)
                        ...
                        <div class="col-12 mt-5 text-center">
                            ...
                            <div class="p-md-5 p-2 bg-white">
                                ...
                                <img src="{{ asset('images/GPS-Logo.jpg.jpeg') }}" class="mb-5" width="200">
                    ...
                    @else
                        <div class="col-12 pb-2 text-center">
                            ...
                            <img src="{{ asset('images/GPS-Logo.jpg.jpeg') }}" width="180">
                            ...
                            <div class="row px-2 justify-content-center">
                                ...
                                @for ($i = 1; $i <= 6; $i++)
                                    <div class="col-lg-6 p-1 text-center">
                                        ...
                                        <div class="my-div mt-2" data-id="{{ $i }}">

                                            <div class="sig{{ $i }} namediv"
                        ...
                        <div class="col-12 text-center text-lg-end">
                            ...
                            <button type="button" class="btn btn-primary px-4 mt-2 Next">
