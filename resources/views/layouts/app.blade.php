                ...
                @if ($role === 'branch')
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link {{ request()->routeIs('branch.reports') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link {{ request()->routeIs('branch.reception.dashboard.reports*') ? 'active' : '' }}"
                ...
                @elseif ($role === 'branch_manager' || $username === 'prabjot' || $username === 'navjot')
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle {{ request()->routeIs('lead.list*') ? 'active' : '' }}"
                ...
                @elseif ($role === 'counselor' && $username !== 'prabjot' && $username !== 'navjot')
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('counselor.dashboard.report') }}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('all.lead.list') }}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('operation.status') }}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('enrolled.list') }}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('fund.release.status') }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item" href="{{ route('counselor.email.templates') }}">
                        ...
                        @if ($username === 'Zainab_admin')
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{ route('appointment.pending') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{ route('appointment.complete') }}">
                ...
                @elseif ($role === 'operation')
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('drop.list') }}">
                        ...
                        @if ($username === 'Accounts')
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{ route('tuition.fee.update') }}">
                ...
                @elseif ($role === 'super_admin')
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item" href="{{ route('admin.branch.report') }}">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item" href="{{ route('admin.walkn.report') }}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('reports.source') }}">
                ...
                @elseif ($role === 'finance')
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('finance.dashboard.report') }}">
